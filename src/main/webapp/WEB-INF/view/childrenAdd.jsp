...
<!-- 헤더 영역 -->
<%@ include file="header.jsp" %>e
<!--콘테이너 영역-->
<form action="/childrenHs/add" method="post">
    ...
    <button type="reset" class="btn btn-secondary btn-sm" onclick="location.href='/childrenHs'">취소</button>
</form>
<!-- 푸터 영역 -->
