...
<head>
  ...
  <title>내 아이 백신 글쓰기 페이지</title>
</head>
<!-- 헤더 영역 -->
<%@ include file="header.jsp" %>
<!--콘테이너 영역-->
${childId}
<form action="/childVaccine/${childId}/add" method="post">
  ...
  <button type="reset" class="btn btn-secondary btn-sm" onclick="location.href='/childVaccine/${childId}'">취소</button>
</form>
<!-- 푸터 영역 -->
